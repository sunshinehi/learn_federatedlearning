...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        writer.add_scalar("FL_CNN_mnist_train_loss", loss_avg, iter + 1)
        ...
        writer.add_scalar("FL_CNN_mnist_acc_train", acc_train, iter + 1)
        print("Testing accuracy: {:.2f}".format(acc_test))
        writer.add_scalar("FL_CNN_mnist_acc_test", acc_test, iter + 1)
